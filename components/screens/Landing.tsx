  ...
  return (
    <div className="scr">
      <div className="nav">
        ...
        <button className="hamburger-icon" aria-label="Open menu">
          ☰
        </button>
      </div>
      ...
      <div className="stat-strip-wrap">
        <div className="stat-strip">
          <div className="big-stat">
            <div className="stat-num accent-num">12</div>
            <div className="stat-lbl">avg matches</div>
          </div>
          <div className="stat-divider"></div>
          <div className="big-stat">
            <div className="stat-num">3 min</div>
            <div className="stat-lbl">to shortlist</div>
          </div>
          <div className="stat-divider"></div>
          <div className="big-stat">
            <div className="stat-num accent-num">0</div>
      ...
      {/* Mobile trust strip (2-up) */}
      <div className="trust-strip-m">
        <div className="trust-item-m">
          <div className="trust-icon-m">🔕</div>
          <div className="trust-title-m">No calls until you ask for one</div>
          <div className="trust-desc-m">We never share your number without your permission.</div>
      ...
      <div className="reviews-m">
        <div className="reviews-label">What students say</div>
      ...
      <div className="bottom-cta-m">
        <button className="cta-primary" onClick={onStart}>
          Start now - takes 3 minutes
        </button>
        <p className="cta-sub-m">No spam, no pressure. Talk to a counselor only if you want to.</p>
      </div>
    </div>
  );
}
